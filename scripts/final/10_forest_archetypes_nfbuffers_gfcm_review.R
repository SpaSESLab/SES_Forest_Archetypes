...
# 3. Plot the evaluation metrics by k with a facet grid for m and beta        ##
# 4. Save the figures                                                         ##
